...
import type { ContentMeta } from '@/server/content-parser-recap';
import { Pagination } from '@/components/base';
import BlogCardList from '@/components/layouts/recap/CardList';
...
export const withLocales = createContentLocales({
  desc: {
    en: 'Recap of mylife : books, people, stories, discoveries...',
    id: '仕事、生活、お金、なんでもいい',
    vn: 'Tạp bút: ghi lại nhật ký về cuộc sống, sách, con người, câu chuyện linh tinh...'
  }
});
